...
SECRET_KEY = 'django-insecure-=%@#1w5^i*0!rs+3r=(7xr+!c##%z)8thbu%l#kn-x6+yiumsx'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        # 'jobApp.auth_backend.CustomTokenAuthentication'
    ),
...
AUTHENTICATION_BACKENDS = [
    'jobApp.auth_backend.CustomEmailBackend',
