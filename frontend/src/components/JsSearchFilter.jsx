...
// import './JsSearchFilter.css'; // Ensure this CSS file is imported
...
//                                         <h5 className="job-title">{result.job_title}</h5>
//                                         <div className="mt-3">
...
//                                         </div>
//                                         <div className="mt-3">
//                                         <a href={`/viewapply/${result.id}`} className="btn btn-primary">View Details & Apply</a>
//                                         </div>
//                                     </div>
//                                 </div>
//                             </div>
