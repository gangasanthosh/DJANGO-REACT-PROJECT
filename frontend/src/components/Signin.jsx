...
//         console.log('Login successful, token and email saved:', response.data.token);
//         // Fetch user type
...
//       let userTypePath = '';
//       if (userTypeResponse.data.usertype === 'jobseeker') {
//         userTypePath = '/jobseeker';
//       } else if (userTypeResponse.data.usertype === 'recruiter') {
//         userTypePath = '/recruiter';
//       } else {
//         setError('Invalid user type');
//         return;
//       }
...
const Signin = () => {
  ...
  const from = location.state?.from?.pathname || '/'; // Default to home if no state is passed
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response.data.token) {
        localStorage.setItem('token', response.data.token);
        localStorage.setItem('email', email);
        console.log('Login successful, token and email saved:', response.data.token, email);
